...
struct StagefrightRecorder : public MediaRecorderBase {
    ...
    virtual status_t setParameters(const String8& params, int state = 0);
...
private:
    ...
    // MStar Android Patch Begin
    status_t startVECaptureRecording();
    // MStar Android Patch End
    ...
    // MStar Android Patch Begin
    // update encoding settings runtime
    status_t setParameter(const String8 &key, const String8 &value, int state = 0);
    // MStar Android Patch End
