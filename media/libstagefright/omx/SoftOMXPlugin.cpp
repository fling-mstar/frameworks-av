...
static const struct {
    ...
    { "OMX.google.mstaac.decoder", "mstaacdec", "audio_decoder.aac"},
    { "OMX.google.mstamrnb.decoder", "mstamrdec", "audio_decoder.amrnb" },
    { "OMX.google.mstamrwb.decoder", "mstamrdec", "audio_decoder.amrwb" },
    { "OMX.google.mstmp3.decoder", "mstmp3dec", "audio_decoder.mp3" },
    ...
    { "OMX.ms.bypass.encoder", "bypassenc", "video_encoder.bypass" },
    // MStar Android Patch End
};
