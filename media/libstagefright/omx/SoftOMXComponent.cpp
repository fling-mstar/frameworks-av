...
SoftOMXComponent::SoftOMXComponent(
    ...
    mComponent->nVersion.s.nVersionMajor = OMX_VERSION_MAJOR;
    mComponent->nVersion.s.nVersionMinor = OMX_VERSION_MINOR;
    mComponent->nVersion.s.nRevision = OMX_VERSION_REVISION;
    mComponent->nVersion.s.nStep = OMX_VERSION_STEP;
