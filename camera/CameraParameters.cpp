...
const char CameraParameters::KEY_TRAVELING_MODE[] = "traveling-mode";
const char CameraParameters::KEY_TRAVELING_RES[] = "traveling-res";
const char CameraParameters::KEY_TRAVELING_MEM_FORMAT[] = "traveling-mem-format";
const char CameraParameters::KEY_TRAVELING_SPEED[] = "traveling-speed";
const char CameraParameters::KEY_TRAVELING_MAGIC_KEY[] = "traveling-magic-key";
const char CameraParameters::KEY_TRAVELING_FRAMERATE[] = "traveling-frame-rate";
const char CameraParameters::KEY_MAIN_INPUT_SOURCE[] = "main-input-source";
const char CameraParameters::KEY_SUB_INPUT_SOURCE[] = "sub-input-source";

// Mstar special parameter keys for dwin hardware fake camera (only for dwincapture)
const char CameraParameters::KEY_DWIN_CAPTURE_MODE[] = "dwincapture-mode";
...
// MStar Android Patch Begin
const char CameraParameters::PIXEL_FORMAT_YUV420TILE[] = "yuv420tile";
// MStar Android Patch End
const char CameraParameters::PIXEL_FORMAT_RGB565[] = "rgb565";
const char CameraParameters::PIXEL_FORMAT_RGBA8888[] = "rgba8888";
// MStar Android Patch Begin
const char CameraParameters::PIXEL_FORMAT_ABGR8888[] = "abgr8888";
// MStar Android Patch End
...
const char CameraParameters::PIXEL_FORMAT_AVC[] = "avc";
// MStar Android Patch End
...
// MStar Android Patch Begin
void CameraParameters::getSupportedThumbnailPictureSizes(Vector<Size> &sizes) const
{
    const char *pictureSizesStr = get(KEY_SUPPORTED_JPEG_THUMBNAIL_SIZES);
    parseSizesList(pictureSizesStr, sizes);
}
// MStar Android Patch End
