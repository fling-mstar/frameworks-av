...
#if ENABLE_DUALMONO
        // for DUALMONO
        DUALMONO_NONE   = 0x4300, 
        DUALMONO_LEFT   = 0x4301,
        DUALMONO_RIGHT  = 0x4303,
#endif
// MStar Android Patch End
    };
...
// Two mm play support speaker and line out
#if ENABLE_DUALMONO
        bool            bDualMonoEnable;
        void            (*mLeftChannelHook)(state_t* state, int64_t pts);
        uint32_t        u32LeftChannelTracks;
        void            (*mRightChannelHook)(state_t* state, int64_t pts);
        uint32_t        u32RightChannelTracks;
#endif
// MStar Android Patch End
