...
enum {
    ...
    METADATA_KEY_AUDIO_SAMPLE_RATE = 25,
    METADATA_KEY_DIVX_DRM_IS_DEVICE_FIRSTTIME_REG  = 26,
    METADATA_KEY_DIVX_DRM_IS_DEVICE_REG  = 27,
    METADATA_KEY_DIVX_DRM_GEN_REG_CODE  = 28,
    METADATA_KEY_DIVX_DRM_GEN_DEREG_CODE  = 29,
