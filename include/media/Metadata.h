...
class Metadata {
  public:
    ...
    // MStar Android Patch Begin
    static const Type kAllAudioCodecType     = 32;
    static const Type kReleaseYearOfAudio    = 33;
    static const Type kCurrentPlayTime       = 34;
    static const Type kTotalTrackNum         = 35;
    static const Type kCurrentAudioTrackID   = 36;
    static const Type kDivxTotalTitleNum     = 37;
    static const Type kDivxTotalEditionNum   = 38;
    static const Type kDivxTotalChapterNum   = 39;
    static const Type kDivxAutoChapterNum    = 40;
    static const Type kDivxFilePos           = 41;
    static const Type kDivxPTS               = 42;
    static const Type kDivxResumeMKV         = 43;
    static const Type kDivxTitle             = 44;
    static const Type kDivxEdition           = 45;
    static const Type kDrmRentalCode         = 46;
    static const Type kDrmRentalFile         = 47;
    static const Type kDrmRentalLimit        = 48;
    static const Type kDrmRentalUseCount     = 49;
    static const Type kDrmCheckSum           = 50;
    static const Type kDrmRentalStatus       = 51;
    static const Type kDrmFileFormat         = 52;
    static const Type kDrmAuthorization      = 53;
    static const Type kVideoIs3D             = 54;
    static const Type kVideoTrackNum         = 55;
    static const Type kOtherVideoCodecID     = 56;
    static const Type kOtherAudiooCodecID    = 57;
    static const Type kAudioLanguageType     = 58;
    static const Type kCurrentAudioCodecType = 59;
    static const Type kCurrentSubtitleTrackID= 60;
    static const Type kCurrentAudioChannelCount = 61;

    static const Type kLastID                = kCurrentAudioChannelCount;
    // MStar Android Patch End
    ...
    // MStar Android Patch Begin
    bool appendLong64(int key, int64_t val);
    bool appendCString16(int key, String16 str);
    bool appendArray(int key, int32_t len, void* data);
    // MStar Android Patch End
